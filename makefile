...
#	ifort -o build/solver2d_tdma.o -c src/solver1d_tdma.f90
...
clean :
	rm build/convergence2d.o build/geometry2d.o build/initialize2d.o build/output_results2d.o build/pressure_solve2d.o build/pressure_correct2d.o build/pressure2d.o build/pseudo_solve2d.o build/pseudo_source2d.o build/simpler2d.o build/solver2d_bicgstab.o build/solver2d_bicgstab2.o build/temperature_solve2d.o build/temperature_source2d.o build/temperature2d.o build/velocity_correct2d.o build/velocity_solve2d.o build/velocity_source2d.o build/velocity2d.o build/main2d.o
